...
require (
	...
	github.com/awalterschulze/gographviz v0.0.0-20190624143730-fa59802746ab // indirect
	...
	moul.io/graphman v1.1.0
	moul.io/graphman/viz v0.0.0-20190723133924-9cfaba2b8149
